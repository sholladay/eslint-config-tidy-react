...
**Important work** comes in many forms. There are labels for [bugs](https://github.com/sholladay/eslint-config-tidy-react/labels/bug) and [easy](https://github.com/sholladay/eslint-config-tidy-react/labels/easy) vs [hard](https://github.com/sholladay/eslint-config-tidy-react/labels/hard) tasks. We also appreciate documentation, examples, tutorials, blogs, videos, books, and other supporting content.
